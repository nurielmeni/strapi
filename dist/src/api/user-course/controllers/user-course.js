...
module.exports = createCoreController('api::user-course.user-course', ({ strapi }) => ({
    ...
    async update(ctx) {
        var _a, _b, _c;
        const { id } = ctx.params;
        const { progress: progressBefore } = (_a = (await strapi.services['user-course'].findOne({ id }))) !== null && _a !== void 0 ? _a : {};
        ...
        const { courseScore } = (_c = (_b = ctx.request.body) === null || _b === void 0 ? void 0 : _b.progress) !== null && _c !== void 0 ? _c : {};
        console.log('courseScore: ', courseScore);
        if (courseScore)
            await updateCompletionDate(entity, courseScore);
