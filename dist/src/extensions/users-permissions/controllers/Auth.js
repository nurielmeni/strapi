...
async function logoutUserPingExpired(user, ctx) {
    ...
    if (((_b = (_a = eventLoginLogout === null || eventLoginLogout === void 0 ? void 0 : eventLoginLogout[0]) === null || _a === void 0 ? void 0 : _a.event_log_type) === null || _b === void 0 ? void 0 : _b.event_type) === 'logout')
        return;
    ...
    if (lastPing < Date.now() - pingTimeout) {
        ...
        const logoutLog = await strapi.services['event-log'].create({
            ...
            event_log_type: eventLogType === null || eventLogType === void 0 ? void 0 : eventLogType.id,
            user: user.id,
...
module.exports = {
    async callback(ctx) {
        ...
        const useragent = (_b = (_a = ctx.header) === null || _a === void 0 ? void 0 : _a['user-agent']) !== null && _b !== void 0 ? _b : [];
        // Verify Chrome
    ...
    async connect(ctx, next) {
        ...
        if (!strapi.config.server.url.startsWith('http')) {
            strapi.log.warn('You are using a third party provider for login. Make sure to set an absolute url in config/server.js. More info here: https://strapi.io/documentation/developer-docs/latest/development/plugins/users-permissions.html#setting-up-the-server-url');
        }
    ...
    async register(ctx) {
        ...
        try {
            ...
            const updatedUser = await strapi.query('user', 'users-permissions').update({ id: user.id }, { i_18_n_locale: locale === null || locale === void 0 ? void 0 : locale.id });
